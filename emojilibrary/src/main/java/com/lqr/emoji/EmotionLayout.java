...
//        mLlTabContainer.removeAllViews();
    ...
    private void initTabs() {
      ...
      /*  EmotionTab emojiTab1 = new EmotionTab(mContext,R.drawable.ic_emoji_1);
        mLlTabContainer.addView(emojiTab1);
        mTabViewArray.put(1, emojiTab1);

        EmotionTab emojiTab2 = new EmotionTab(mContext, R.drawable.ic_emoji_2);
        mLlTabContainer.addView(emojiTab2);
        mTabViewArray.put(2, emojiTab2);*/
