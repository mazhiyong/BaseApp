package com.lr.biyou.rongyun.net;

public class SealTalkUrl {

    //public static final String DOMAIN = "http://api.sealtalk.im/";
    public static final String DOMAIN = "http://by.qilinpz.com/index/";
    ...
    //***  获取好友信息
    public static final String GET_FRIEND_PROFILE = "chat_user/friendDetail";
