...
import com.lr.biyou.rongyun.db.model.FriendDetailInfo;
...
import com.lr.biyou.rongyun.ui.widget.SelectableRoundedImageView;
...
import com.lr.biyou.rongyun.viewmodel.PrivateChatSettingViewModel;
...
public class PrivateChatSettingActivity extends TitleBaseActivity implements View.OnClickListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_START_GROUP && resultCode == Activity.RESULT_OK) {
