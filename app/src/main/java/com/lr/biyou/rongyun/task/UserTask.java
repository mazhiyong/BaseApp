package com.lr.biyou.rongyun.task;
...
import com.lr.biyou.rongyun.db.model.FriendBlackInfo;
import com.lr.biyou.rongyun.db.model.GroupEntity;
import com.lr.biyou.rongyun.db.model.UserInfo;
import com.lr.biyou.rongyun.file.FileManager;
import com.lr.biyou.rongyun.im.IMManager;
import com.lr.biyou.rongyun.model.BlackListUser;
import com.lr.biyou.rongyun.model.ContactGroupResult;
import com.lr.biyou.rongyun.model.LoginResult;
import com.lr.biyou.rongyun.model.RegionResult;
import com.lr.biyou.rongyun.model.RegisterResult;
...
import com.lr.biyou.rongyun.model.VerifyResult;
import com.lr.biyou.rongyun.net.HttpClientManager;
import com.lr.biyou.rongyun.net.RetrofitUtil;
import com.lr.biyou.rongyun.net.service.UserService;
import com.lr.biyou.rongyun.sp.CountryCache;
import com.lr.biyou.rongyun.sp.UserCache;
import com.lr.biyou.rongyun.utils.CharacterParser;
import com.lr.biyou.rongyun.utils.NetworkBoundResource;
import com.lr.biyou.rongyun.utils.NetworkOnlyResource;
...
public class UserTask {
    ...
    public LiveData<Resource<UserInfo>> getUserInfo(final String userId) {
        ...
        userInfo.setId(MbsConstans.RONGYUN_MAP.get("id")+"");
        userInfo.setName(MbsConstans.RONGYUN_MAP.get("name")+"");
        userInfo.setPortraitUri(MbsConstans.RONGYUN_MAP.get("portrait")+"");
