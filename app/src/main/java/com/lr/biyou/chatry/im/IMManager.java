...
import com.lr.biyou.chatry.im.message.GroupApplyMessage;
import com.lr.biyou.chatry.im.message.RongRedPacketMessage;
import com.lr.biyou.chatry.im.message.RongRedPacketMessageProvider;
import com.lr.biyou.chatry.im.message.SealContactNotificationMessage;
import com.lr.biyou.chatry.im.message.SealGroupConNtfMessage;
import com.lr.biyou.chatry.im.message.SealGroupNotificationMessage;
import com.lr.biyou.chatry.im.provider.ContactNotificationMessageProvider;
import com.lr.biyou.chatry.im.provider.GroupApplyMessageProvider;
import com.lr.biyou.chatry.im.provider.SealGroupConNtfMessageProvider;
import com.lr.biyou.chatry.im.provider.SealGroupNotificationMessageItemProvider;
import com.lr.biyou.chatry.model.ChatRoomAction;
import com.lr.biyou.chatry.model.ContactNotificationMessageData;
import com.lr.biyou.chatry.model.LoginResult;
import com.lr.biyou.chatry.model.QuietHours;
import com.lr.biyou.chatry.model.Resource;
import com.lr.biyou.chatry.model.UserCacheInfo;
import com.lr.biyou.chatry.net.CallBackWrapper;
import com.lr.biyou.chatry.net.HttpClientManager;
import com.lr.biyou.chatry.net.service.UserService;
import com.lr.biyou.chatry.sp.UserCache;
import com.lr.biyou.chatry.sp.UserConfigCache;
import com.lr.biyou.chatry.ui.activity.ForwardActivity;
import com.lr.biyou.chatry.ui.activity.GroupNoticeListActivity;
import com.lr.biyou.chatry.ui.activity.NewFriendListActivity;
import com.lr.biyou.chatry.ui.activity.SealPicturePagerActivity;
...
public class IMManager {
    ...
    public void connectIM(String token, boolean getTokenOnIncorrect, ResultCallback<String> callback) {
        LogUtilDebug.i("show","*&&&&&&&&&&&&&&&&&&&"+token);
         //  考虑到会有后台调用此方法，所以不采用 LiveData 做返回值
        RongIM.connect(token, new RongIMClient.ConnectCallback() {
            @Override
            public void onTokenIncorrect() {
                LogUtilDebug.i("show","token过期");
            ...
            public void onSuccess(String s) {
                ...
                LogUtilDebug.i("show","链接成功");
            }

            @Override
            public void onError(RongIMClient.ErrorCode errorCode) {
                LogUtilDebug.i("show","链接失败"+errorCode);
