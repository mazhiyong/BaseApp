...
import com.lr.biyou.ui.temporary.adapter.PayPlanAdapter;
 ...
 * 还款计划   界面
 */
public class PayPlanActivity extends BasicActivity implements RequestView,ReLoadingData{
    ...
    public void init() {
        ...
        mTitleText.setText(getResources().getString(R.string.borrow_repay_plan));
    ...
    private void initView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(PayPlanActivity.this);
    ...
    private void responseData() {
        if (mPayPlanAdapter == null) {
            mPayPlanAdapter = new PayPlanAdapter(PayPlanActivity.this);
            mPayPlanAdapter.addAll(mDataList);

            List<Boolean>  booleans  = new ArrayList<>();
            for (Map<String,Object> map : mPayPlanAdapter.getDataList()){
                booleans.add(false);
            }

            mPayPlanAdapter.setShowList(booleans);
            ...
            mLRecyclerViewAdapter = new LRecyclerViewAdapter(mPayPlanAdapter);
...
//            mLRecyclerViewAdapter.addHeaderView(headerView);
            ...
            mLRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(View view, int position) {
                    Map<String, Object> item = mPayPlanAdapter.getDataList().get(position);
...
//设置底部加载颜色
        ...
        mPayPlanAdapter.notifyDataSetChanged();
        if (mPayPlanAdapter.getDataList().size() <= 0){
            mPageView.showEmpty();
        }else {
