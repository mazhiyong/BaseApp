...
public class ZhangHuListAdapter extends RecyclerView.Adapter<ZhangHuListAdapter.MyHolder> {
    ...
    public ZhangHuListAdapter(Context context, List<Map<String, Object>> list) {
        super();
    ...
    public void onBindViewHolder(final MyHolder holder, final int position) {
        ...
        holder.mItemName.setText(map.get("orgname")+"");
