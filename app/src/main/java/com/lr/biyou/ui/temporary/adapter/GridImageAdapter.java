...
public class GridImageAdapter extends
    ...
    public interface onAddPicClickListener {
        void onAddPicClick(String mType);

        void onDeleClick(int position,String mType);
    }

    public GridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener,String mType) {
    ...
    public interface OnItemClickListener {
        void onItemClick(int position, View v,String mType);
    }
