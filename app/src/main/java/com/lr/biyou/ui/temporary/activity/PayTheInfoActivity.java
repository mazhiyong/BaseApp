...
import com.lr.biyou.ui.temporary.adapter.PayTheAdapter;
 ...
 * 受托支付信息   界面
 */
public class PayTheInfoActivity extends BasicActivity implements RequestView,ReLoadingData{
    ...
    private PayTheAdapter mPayTheAdapter;
    ...
    public void init() {
        ...
        mTitleText.setText(getResources().getString(R.string.pay_the_info));
    ...
    private void initView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(PayTheInfoActivity.this);
    ...
    private void responseData() {
        if (mPayTheAdapter == null) {
            mPayTheAdapter = new PayTheAdapter(PayTheInfoActivity.this);
            ...
            mLRecyclerViewAdapter = new LRecyclerViewAdapter(mPayTheAdapter);
...
//            mLRecyclerViewAdapter.addHeaderView(headerView);
            ...
            mLRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(View view, int position) {
                    Map<String, Object> item = mPayTheAdapter.getDataList().get(position);
...
//设置底部加载颜色
        ...
        mPayTheAdapter.notifyDataSetChanged();
        if (mPayTheAdapter.getDataList().size() <= 0){
            mPageView.showEmpty();
        }else {
