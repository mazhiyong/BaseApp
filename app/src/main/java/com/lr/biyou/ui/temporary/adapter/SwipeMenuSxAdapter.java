...
public class SwipeMenuSxAdapter extends ListBaseAdapter {
    ...
    public SwipeMenuSxAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SuperViewHolder(mLayoutInflater.inflate(R.layout.list_item_swipe, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
       ...
       // viewHolder.mGuanxiTv.setText(map.get("gtfirmname") + "");
        viewHolder.mIdcardValueTv.setText(UtilTools.getIDCardXing(map.get("gtjkzjno") + ""));
