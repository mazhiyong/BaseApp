...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        GlobalApplication.getContext().startActivity(
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm =
                (ConnectivityManager) GlobalApplication.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        if (cm == null) {
            return null;
        }
    ...
    public static boolean setMobileDataEnabled(final boolean enabled) {
        try {
            TelephonyManager tm =
                    (TelephonyManager) GlobalApplication.getContext().getSystemService(Context.TELEPHONY_SERVICE);
            if (tm == null) {
                return false;
            }
    ...
    public static boolean isMobileDataAvailable() {
        return getMobileDataEnabled() && isAvailableByPing();
    }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) GlobalApplication.getContext().getSystemService(WIFI_SERVICE);
        if (manager == null) {
            return false;
        }
...
//                }
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) GlobalApplication.getContext().getSystemService(WIFI_SERVICE);
        if (wm == null) {
            return "";
        }
